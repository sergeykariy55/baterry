...
<div class="container">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse" id=bs-example-navbar-collapse-1>
     ...
     <ul id="menu" class="nav text-center nav-center menu-ul">
   
        <?php foreach ($categories as $category) { ?> 
					<?php if ($category['children']) { ?>
						<li class="dropdown cat-menu"><a href="<?php echo $category['href']; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $category['name']; ?></a>
